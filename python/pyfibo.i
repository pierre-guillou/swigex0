...
%fragment("ToStdVector", "header", fragment="Conversions")
{
...
%typemap(in, fragment="ToStdVector") const VectorDouble& (VectorDouble container),
...
%fragment("FromStdVector", "header", fragment="Conversions")
{
  template <typename Container>
...
%typemap(out, noblock=1, fragment="FromStdVector") VectorDouble,
                                                   VectorInt
{
  $result = createNumpyArrayFromContainer($1);
}

%typemap(in, fragment="Conversions") double
{
...
%typemap(out, noblock=1, fragment="Conversions") double
{
